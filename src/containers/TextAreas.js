...
const TextAreas = ({ sendValueToStore }) => {
  ...
  return(
    <div className="textarea-container">
      <textarea placeholder="Input the text" ref={enArea} name="en" className="en-textarea"></textarea>
      <textarea placeholder="Введите текст" ref={ruArea} name="ru" className="ru-textarea"></textarea>
    </div>
  )
}
